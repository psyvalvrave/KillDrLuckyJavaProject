...
public class GameControllerTest {
    ...
    @Test
    public void testDisplayRoomInfo() throws InterruptedException, FileNotFoundException {
    ...
    @Test
    public void testAddHumanPlayer() throws InterruptedException, FileNotFoundException {
      String simulatedUserInput = "1\nHumanPlayer\n1\n4\n1\n1\n0\n"; 
      Readable consoleInput = new StringReader(simulatedUserInput);
      consoleOutput = new StringWriter();
      RandomNumberGenerator rng = new RandomNumberGenerator();
    ...
    @Test
    public void testAddComputerPlayer() throws InterruptedException, FileNotFoundException {
    ...
    @Test
    public void testPlayerMove() throws InterruptedException, FileNotFoundException {
      String simulatedUserInput = "1\nHumanPlayer\n1\n4\n5\n2\n0\n"; 
      Readable consoleInput = new StringReader(simulatedUserInput);
      consoleOutput = new StringWriter();
      RandomNumberGenerator rng = new RandomNumberGenerator();
    ...
    @Test
    public void testPlayerPickUp() throws InterruptedException, FileNotFoundException {
      String simulatedUserInput = "1\nHumanPlayer\n1\n4\n6\n1\n0\n"; 
      Readable consoleInput = new StringReader(simulatedUserInput);
      consoleOutput = new StringWriter();
      RandomNumberGenerator rng = new RandomNumberGenerator();
      ...
      Readable fileInput = new FileReader("res/mansion.txt");
        ...
        assert(consoleOutput.toString().contains("Item 'Revolver' picked up successfully by HumanPlayer"));
    }
    
    @Test
    public void testPlayerLookAround() throws InterruptedException, FileNotFoundException {
      String simulatedUserInput = "1\nHumanPlayer\n1\n4\n7\n0\n"; 
      Readable consoleInput = new StringReader(simulatedUserInput);
      consoleOutput = new StringWriter();
      RandomNumberGenerator rng = new RandomNumberGenerator();
      ...
      Readable fileInput = new FileReader("res/mansion.txt");
        ...
        assert(consoleOutput.toString().contains("Room ID: 2, Room Name: Billiard Room, Items: Billiard Cue"));
    ...
    @Test
    public void testPlayerDisplayInfo() throws InterruptedException, FileNotFoundException {
      String simulatedUserInput = "1\nHumanPlayer\n1\n4\n7\n8\n0\n0\n"; 
      Readable consoleInput = new StringReader(simulatedUserInput);
      consoleOutput = new StringWriter();
      RandomNumberGenerator rng = new RandomNumberGenerator();
      ...
      Readable fileInput = new FileReader("res/mansion.txt");
        ...
        gameController.playGame(world);
        assert(consoleOutput.toString().contains("ID: 0, Name: HumanPlayer, Current Room: Armory, Items:"));
    }
}
